...
struct MessageItem: Identifiable, Hashable {
    ...
    static func from(document: DocumentSnapshot, organizationId: String) -> MessageItem {
...
// 既存コードで MemberMessageItem を使っていても通るように別名を用意
typealias MemberMessageItem = MessageItem
