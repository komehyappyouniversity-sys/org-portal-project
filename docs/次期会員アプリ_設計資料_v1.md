...
| イベント予約 | 未着手 | 未着手 | 未作成 | ☐ |
| コミュニティ接続・切替・サーフィン | コード・QR参加申請、承認状態表示、承認済みコミュニティ切替、権限を持つ運営者の申請一覧・承認・却下を実装・単体テスト済み | コード・QR参加申請、承認状態表示、承認済みコミュニティ切替、権限を持つ運営者の申請一覧・承認・却下を実装・単体テスト済み | コード単体・招待URLの共通解析、本人申請と状態改変防止、管理権限・監査記録、切替・元のコミュニティへ戻る動作を両OSで検証。公開コミュニティ検索・サーフィンは後続タスク | ☐ |
