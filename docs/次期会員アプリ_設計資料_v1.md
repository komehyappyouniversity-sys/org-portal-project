...
| イベント予約 | 未着手 | 未着手 | 未作成 | ☐ |
| コミュニティ接続・切替・サーフィン | コード・QR参加申請、承認状態表示、承認済みコミュニティ切替を実装・単体テスト済み | コード・QR参加申請、承認状態表示、承認済みコミュニティ切替を実装・単体テスト済み | コード単体・招待URLの共通解析、本人申請と状態改変防止、切替・元のコミュニティへ戻る動作を両OSで検証。公開検索・運営者の承認画面は後続タスク | ☐ |
